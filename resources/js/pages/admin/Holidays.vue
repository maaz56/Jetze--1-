...
import { useHolidayStore } from "@/services/stores/holiday";

const store = useHolidayStore(); // Use the Pinia store

const holidays = computed(() => store.holidays); // Access state directly
const initialHeaderImages = computed(() => store.headerImages); // Access state directly

const headerImages = ref([]);
const removeFiles = ref(false);

function fetchHolidays() {
    store.fetchHolidays(); // Call the action directly
}

function fetchHolidayHeaderImages() {
    store.fetchHolidayHeaderImages(); // Call the action directly
}

function saveHeaderImages() {
    store.saveHeaderImages({
...
function deleteHolidayHeaderImage(name) {
    store.deleteHolidayHeaderImage({
        file_name: name,
    }); // Call the action directly
}
    ...
    <section>
        <div>
            <div class="flex items-center justify-between my-8">
                <span class="text-3xl font-medium">Holidays</span>
                ...
                <div class="flex gap-2">
                    ...
                    <Button @click="$router.push({ name: 'NewHoliday' })"
                        >New Holiday</Button>
                </div>
            </div>
            <div
                    ...
                    >
                        ...
                        <tbody>
                            ...
                            >
                                ...
                                <td class="px-4 py-3">{{ holiday.title }}</td>
                                <td class="px-4 py-3">
