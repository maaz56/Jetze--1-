    ...
    <section>
        <div>
            <div class="flex items-center justify-between my-8">
                ...
                <Button @click="$router.push({ name: 'NewAirline' })">New Air Line</Button>
            </div>
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3 ">IATA Country Code</th>
                                <th scope="col" class="px-4 py-3 ">IATA Code</th>
                                <th scope="col" class="px-4 py-3 ">IATA City Code</th>
                                <th scope="col" class="px-4 py-3 ">City Name</th>
                                ...
                                <td class="px-4 py-3 flex items-center justify-end">
                                    ...
                                    <div id="benq-ex2710q-dropdown"
                                        ...
                                        <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                            ...
                                            <li>
                                                <router-link :to="{ name: 'UpdateAirport' }">
                                                    <a href="#"
                                        ...
                                        <div class="py-1">
                                            <AlertDialog>
                                                <AlertDialogTrigger class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Delete</AlertDialogTrigger>
                                                <AlertDialogContent>
                                                    <AlertDialogHeader>
