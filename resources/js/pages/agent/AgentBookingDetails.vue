    ...
    <section>
        <div class="min-h-screen bg-gray-100">
            ...
            <div v-for="booking in bookingDetails" :key="booking.id"
                class="bg-white p-4 gap-2 flex justify-end max-w-6xl mx-auto " id="topBar">
                ...
                <button @click="isConfirmDialogOpen = true"
                    :disabled="['canceled', 'ticketed'].includes(booking?.status?.toLowerCase())"
                    class="px-4 py-2 text-sm font-medium text-gray-700 bg-gray-100 rounded-md hover:bg-gray-200 disabled:bg-gray-300 disabled:cursor-not-allowed">
                    Confirm Booking
                </button>
                    ...
                    <div class="bg-white rounded-lg shadow-xl max-w-md w-full p-6 transform transition-all">
                        ...
                        <div class="mt-6 flex justify-end space-x-3">
                            ...
                            <button @click="confirmBooking"
                                class="px-4 py-2 bg-primary border border-transparent rounded-md text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
                                Confirm Booking
                            </button>
                        </div>
                    </div>
            ...
            <div v-for="booking in bookingDetails" :key="booking.id" id="print-section"
                    ...
                    <div v-if="parseFlightData(booking.flight_data)" class="space-y-3">
                        <div v-for="(leg, legIndex) in parseFlightData(booking.flight_data).legs" :key="legIndex"
                            ...
                            <div v-for="(stop, stopIndex) in leg.stops" :key="stopIndex">
                                    ...
                                    <div class="flex items-center justify-between flex-1 w-full">
                                        ...
                                        <div class="flex flex-col items-center px-1">
                                            ...
                                            <div class="text-xs text-gray-500 mt-0.5">
                                                {{ getDuration(
                                                    (parseFlightData(booking.pnr_response)
                                                        .CreatePassengerNameRecordRS
                                                        .TravelItineraryRead
                                                        .TravelItinerary
                                                        .ItineraryInfo
                                ...
                                <div v-if="stopIndex < leg.stops.length - 1"
                                    ...
                                    <div
                                        ...
                                        <span class="font-medium">
                                            Layover: {{ calculateLayoverTime(
                                                ...
                                                (parseFlightData(booking.pnr_response)
                                                    ...
                                                    .TravelItinerary
                                                    .ItineraryInfo
                                                    .ReservationItems.Item[stopIndex + 1]
                                                    .Product
                                                    .ProductDetails
                                                    .Air
                                                    .DepartureDateTime).toString()
                                        ...
                                        <span>at {{ stop.arrival.airport.name }} ({{ stop.arrival.airport.iata_code
                                            }})</span>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="bg-white p-4">
                    ...
                    <ul class="list-disc pl-5 space-y-2 text-gray-700">
                        ...
                        <li>Date change policy follows airline rules plus an additional Jetze service charge.
                        </li>
                        <li>Jetze service charge: PKR 1000 per passenger.</li>
                    </ul>
                </div>
