...
async function saveBooking(type) {
    try {
        ...
        await store.dispatch("flight/" + SAVE_BOOKING, {
            ...
            flight: flight.value,
            flight_type: route.query.flight_type || 'one-way',
...
<template>
            ...
            <div class="flex gap-x-3">
                ...
                <div class="w-3/4">
                    ...
                    <div class="w-full mx-auto mt-1  bg-white shadow-sm  border-gray-200">
                        <div
                            class="p-4 sm:p-6 flex items-center justify-between bg-gradient-to-r from-gray-50 to-white">
                                    ...
                                    <AccordionContent class="bg-white border-0 p-0">
                                        ...
                                        <div class="flex flex-col sm:flex-row items-start gap-4 px-4 my-4">
                                            ...
                                            <div class="flex-1">
                                                ...
                                                <Label class="text-sm font-medium text-gray-700 mb-2 block">Upload
                                                    Passport Image</Label>
                                                <div class="flex flex-col sm:flex-row items-center gap-3">
                                                    <input type="file" accept="image/*" ref="passportUpload"
                                                        @change="handlePassportUpload($event, index)" class="hidden"
                                            ...
                                            <div v-if="scanning" class="flex items-center gap-2 mt-2 sm:mt-0">
                                                <svg class="animate-spin h-4 w-4 text-blue-500" fill="none"
                                                    viewBox="0 0 24 24">
                                                ...
                                                <SelectContent class="bg-white border-gray-200 w-[200px]">
                                                    <SelectGroup>
                                                        <SelectItem :value="index"
                                                            ...
                                                            :key="agentTraveller.id">{{ agentTraveller.title }} {{
                                                            agentTraveller.first_name }} {{ agentTraveller .last_name }}
                                                        </SelectItem>
                                        ...
                                        <div class="p-4 sm:p-6">
                                            ...
                                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                                                ...
                                                <div v-if="traveller.type == 'ADT'" class="space-y-2">
                                                    ...
                                                    <Input v-model="traveller.cnic" :id="`cnic-no-${index}`" type="text"
                                                        class="w-full h-10 text-sm bg-white border-gray-200 focus:border-primary focus:ring-primary/20"
                                        ...
                                        <div v-if="traveller.showAncillaries" class="bg-white border-t border-gray-100">
                                            <Tabs default-value="baggage" class="w-full">
                                                ...
                                                <TabsContent value="baggage" class="p-4 sm:p-6">
                                                    <div class="mb-6">
                                                        <h4 class="text-lg font-semibold text-gray-800 mb-2">About your
                                                            baggage</h4>
                                                        <p class="text-sm text-gray-600">
                                                            Need additional baggage? Save time and money by purchasing
                                                            extra baggage in advance
                                                        </p>
                                                    </div>
                                                    ...
                                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                        <div v-for="(flight, flightIdx) in flight?.leg?.flights"
                                                            ...
                                                            <h5
                                                                ...
                                                                {{ flight?.from?.city?.name }} to {{
                                                                flight?.to?.city?.name }}
                                                            </h5>

                                                            <div v-for="(segment, segmentIdx) in flight?.segments"
                                                                :key="segmentIdx" class="mb-6 last:mb-0">
                                                                <div
                                                                ...
                                                                <div v-for="fare in flight?.fares" :key="fare.ref_id">
                                                                    <div v-if="selectedFares?.includes(fare?.ref_id)"
                                                                        ...
                                                                        <div v-else
                                                                            ...
                                                                            <p class="text-sm text-gray-600">Checked
                                                                                baggage not included</p>
                                                                        </div>
                                                                    </div>
                                                                </div>

                                                                <!-- Selected extra baggage preview -->
                                                                <div v-if="extraCharges[flightIdx]?.baggage?.[segmentIdx]?.[index]"
                                                                    ...
                                                                    <div class="flex items-center justify-between">
                                                                        <div class="flex items-center gap-2">
                                                                            ...
                                                                            <div>
                                                                                <p
                                                                                    class="text-sm font-medium text-gray-900">
                                                                                    Extra baggage: {{
                                                                                    selectedExtras[flightIdx]?.baggage?.[segmentIdx]?.[index]?.title
                                                                                    }}
                                                                                </p>
                                                                                <p class="text-xs text-gray-600">
                                                                                    {{
                                                                                    selectedExtras[flightIdx]?.baggage?.[segmentIdx]?.[index]?.currency
                                                                                    }} {{
                                                                                    selectedExtras[flightIdx]?.baggage?.[segmentIdx]?.[index]?.amount
                                                                                    }}
                                                                                </p>
                                                                            </div>
                                                                        </div>
                                                                        <button
                                                                            ...
                                                                            @click="() => { delete extraCharges[flightIdx].baggage[segmentIdx][index]; delete selectedExtras[flightIdx].baggage[segmentIdx][index]; }"
                                                                    ...
                                                                    <p class="text-xs text-gray-500 mt-2">
                                                                        {{
                                                                        selectedExtras[flightIdx]?.baggage?.[segmentIdx]?.[index]?.description
                                                                        }}
                                                                    </p>
                                                                </div>
                                                                    ...
                                                                    <DialogContent
                                                                        ...
                                                                        <DialogHeader
                                                                            ...
                                                                            <DialogTitle
                                                                                ...
                                                                                Add your extra baggage</DialogTitle>
                                                                            <DialogDescription
                                                                                class="text-sm text-gray-600">
                                                                                You can select here which baggage you
                                                                                prefer
                                                                            </DialogDescription>
                                                                        </DialogHeader>
                                                                        <div class="flex-1 overflow-y-auto mt-4 pr-2">
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <label
                                                                                    ...
                                                                                    :class="{ 'border-primary ring-2 ring-primary/20 bg-primary/5': selectedExtras[flightIdx]?.baggage?.[segmentIdx]?.refId === option.ref_id, 'border-gray-200': selectedExtras[flightIdx]?.baggage?.[segmentIdx]?.refId !== option.ref_id }">
                                                                                    <div
                                                                                    ...
                                                                                    <div class="flex items-center mb-3">
                                                                                        <input type="radio"
                                                                                            ...
                                                                                            :value="option.ref_id"
                                                                                            @change="handleExtraChange(flightIdx, segment.ref_id, segmentIdx, index, option, 'baggage')" />
                                                                                        <span
                                                ...
                                                <TabsContent value="seats" class="p-4 sm:p-6">
                                                    <div v-if="ancillaries?.providers?.length">
                                                        <div class="mb-6">
                                                            <h4 class="text-lg font-semibold text-gray-800 mb-2">Want
                                                                your own seat?</h4>
                                                            <p class="text-sm text-gray-600">
                                                        ...
                                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                            <div v-for="(flight, flightIdx) in flight?.leg?.flights"
                                                                ...
                                                                <div v-for="(segment, segmentIdx) in flight?.segments"
                                                                    ...
                                                                    <div v-if="extraCharges[flightIdx]?.seat?.[segmentIdx]?.[index]"
                                                                        class="p-3 bg-blue-50 rounded-lg border border-blue-200 mb-4">
                                                                        <div class="flex items-center justify-between">
                                                                            <p
                                                                                class="text-sm font-medium text-gray-900">
                                                                                {{ getSelectedSeatInfo(flightIdx,
                                                                                segmentIdx) }}
                                                                            </p>
                                                                            <button
                                                                                class="px-3 py-1 text-xs rounded-md bg-red-100 text-red-600 hover:bg-red-200 transition-colors duration-200"
                                                                                @click="() => { delete extraCharges[flightIdx].seat[segmentIdx][index]; delete selectedExtras[flightIdx].seat[segmentIdx][index]; delete selectedSeat[flightIdx][segmentIdx][index]; }"
                                                                                title="Remove seat">
                                                                                Remove
                                                                            </button>
                                                                        </div>
                                                                        ...
                                                                        <DialogContent
                                                                            ...
                                                                            <DialogHeader
                                                                                ...
                                                                                <DialogDescription
                                                                                    ...
                                                                                    segment?.from?.name || 'Unknown' }}
                                                                                    to {{ segment?.to?.name || 'Unknown'
                                                                                    }}
                                                                                </DialogDescription>
                                                                            </DialogHeader>
                                                                            <div class="mt-6">
                                                                                                        ...
                                                                                                        <template
                                                                                                            ...
                                                                                                            <div v-if="seat && seat.availability_type === 'available'"
                                                                                                                ...
                                                                                                                <label
                                                                                                                    ...
                                                                                                                    :class="{ 'border-green-500 bg-green-50 text-green-800': selectedSeat[flightIdx]?.[segmentIdx] !== seat.ref_id, 'border-primary bg-primary/10 text-primary': selectedSeat[flightIdx]?.[segmentIdx] === seat.ref_id }">
                                                                                                                    <input
                                                                                                                        type="radio"
                                                                                                                        class="sr-only"
                                                                                                                        ...
                                                                                                                        :value="seat.ref_id"
                                                                                                                        @change="handleExtraChange(flightIdx, segment.ref_id, segmentIdx, index, { ref_id: seat.ref_id, title: seat.seat_no, description: seat.type || 'Standard seat', amount: seat.amount || 0, currency: seat.currency?.symbol || '', }, 'seat')" />
                                                                                                                    {{
                                                                                ...
                                                                                <div v-else
                                                                                    class="text-sm text-gray-500 bg-gray-50 p-4 rounded-lg">
                                                                                    No seat map available for this
                                                                                    segment.
                                                                                </div>
                                                    ...
                                                    <!-- Show message if no seat selection is available for this segment -->
                                                    <p v-else class="text-sm text-gray-500 bg-gray-50 p-3 rounded-lg">
                                                        No extra seat selection services available for this segment.
                                                    </p>
                                                </TabsContent>
                                                ...
                                                <TabsContent value="meals" class="p-4 sm:p-6">
                                                    <div v-if="ancillaries">
                                                        <div class="mb-6">
                                                            <h4 class="text-lg font-semibold text-gray-800 mb-2">Add
                                                                Meals</h4>
                                                            <p class="text-sm text-gray-600">
                                                        ...
                                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                            <div v-for="(flightItem, flightIdx) in flight?.leg?.flights"
                                                                ...
                                                                <div v-for="(segment, segmentIdx) in flightItem?.segments"
                                                                    ...
                                                                    <div v-if="extraCharges?.[flightIdx]?.meal?.[segmentIdx]?.[index]"
                                                                        class="p-3 bg-blue-50 rounded-lg border border-blue-200 mb-4">
                                                                        <div class="flex items-center justify-between">
                                                                            <div>
                                                                                <div
                                                                                    ...
                                                                                    <p
                                                                                        class="text-sm font-medium text-gray-900">
                                                                                        Meal: {{
                                                                                        selectedExtras?.[flightIdx]?.meal?.[segmentIdx]?.[index]?.title
                                                                                        }}
                                                                                    </p>
                                                                                </div>
                                                                                <p class="text-xs text-gray-600 ml-6">
                                                                                    {{
                                                                                    selectedExtras?.[flightIdx]?.meal?.[segmentIdx]?.[index]?.currency
                                                                                    }} {{
                                                                                    selectedExtras?.[flightIdx]?.meal?.[segmentIdx]?.[index]?.amount
                                                                                    }}
                                                                                    × {{
                                                                                    selectedExtras?.[flightIdx]?.meal?.[segmentIdx]?.[index]?.qty
                                                                                    || 1 }}
                                                                                </p>
                                                                            </div>
                                                                            <button
                                                                                class="px-3 py-1 text-xs rounded-md bg-red-100 text-red-600 hover:bg-red-200 transition-colors duration-200"
                                                                                @click="() => { delete extraCharges[flightIdx].meal[segmentIdx][index]; delete selectedExtras[flightIdx].meal[segmentIdx][index]; }"
                                                                                title="Remove meal">
                                                                                Remove
                                                                            </button>
                                                                        </div>
                                                                        <p class="text-xs text-gray-500 mt-2 ml-6">
                                                                            {{
                                                                            selectedExtras?.[flightIdx]?.meal?.[segmentIdx]?.[index]?.description
                                                                            }}
                                                                        </p>
                                                                    </div>
                                                                    ...
                                                                    <Dialog v-if="ancillaries">
                                                                        ...
                                                                        <DialogContent
                                                                            ...
                                                                            <DialogHeader
                                                                                ...
                                                                                <DialogTitle
                                                                                    class="text-xl font-semibold text-gray-800">
                                                                                    Add your meal</DialogTitle>
                                                                                <DialogDescription
                                                                                    class="text-sm text-gray-600">
                                                                                    Select your preferred meal for this
                                                                                    flight segment.
                                                                                </DialogDescription>
                                                                            </DialogHeader>
                                                                            <div
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <label
                                                                                        ...
                                                                                        :key="meal?.ref_id"
                                                                                        class="block border-2 rounded-xl shadow-sm p-4 cursor-pointer transition-all duration-200 hover:shadow-lg hover:-translate-y-1 bg-white"
                                                                                        :class="{ 'border-primary ring-2 ring-primary/20 bg-primary/5': selectedExtras?.[flightIdx]?.meal?.[segmentIdx]?.ref_id === meal?.ref_id, 'border-gray-200': selectedExtras?.[flightIdx]?.meal?.[segmentIdx]?.ref_id !== meal?.ref_id }">
                                                                                        <div
                                                                                            class="h-32 mb-4 rounded-lg overflow-hidden  flex items-center justify-center">
                                                                                            <img :src="meal?.image"
                                                                                                :alt="meal?.title"
                                                                                                class="h-full object-contain" />
                                                                                        </div>
                                                                                        <div
                                                                                            ...
                                                                                            <input type="radio"
                                                                                                ...
                                                                                                @change="handleExtraChange(flightIdx, segment.ref_id, segmentIdx, index, { ...meal, qty: meal?.qty || 1 }, 'meal')" />
                                                                                            <span
                                                                                                class="text-sm font-semibold text-gray-800">{{
                                                                                                meal?.title }}</span>
                                                                                        </div>
                                                                                        <div
                                                                                            class="text-xs text-primary font-medium mb-2 bg-primary/10 px-2 py-1 rounded">
                                                                                            {{ meal?.category }}
                                                                                        </div>
                                                                                        <div
                                                                                        ...
                                                                                        <div
                                                                                            class="flex items-center justify-center gap-3 bg-gray-50 p-2 rounded-lg">
                                                                                            <!-- Decrease -->
                                                                                            <button
                                                                                                class="w-8 h-8 rounded-full border-2 border-gray-300 flex items-center justify-center text-gray-600 hover:bg-white hover:border-primary hover:text-primary transition-all duration-200"
                                                                                                @click="
                                                                                            ...
                                                                                            <!-- Qty Display -->
                                                                                            <span
                                                                                                class="text-sm font-semibold min-w-[2rem] text-center">
                                                                                                {{ meal?.qty || 1 }}
                                                                                            </span>
                                                    ...
                                                    <p v-else class="text-sm text-gray-500 bg-gray-50 p-3 rounded-lg">
                                                        No extra Meal selection services available for this segment.
                                                    </p>
                                                </TabsContent>
                                            </Tabs>
                                        </div>
                    ...
                    <div>
                        ...
                        <p class="space-y-2">
                            <span>1. For any amendments, cancellation, or ancillary services for flights, contact our
                                ...
                                <a href="tel:+923111448111" class="underline text-blue-500 hover:text-blue-700">+971 52
                                    901 3757</a>
                                or email
                                <a href="mailto:support@Jetze.pk"
                                    class="underline text-blue-500 hover:text-blue-700">support@Jetze.pk</a>.
                            </span><br>
    ...
    <div v-else>
        <div v-if="!isLoading && flight">
            <div class="flex gap-x-3">
                <div class="w-3/4">
                    <div class="bg-white rounded-lg">
                        ...
                        <div class="border-b p-2">
                            <span class="text-xl font-bold">Flight Details </span><span class="font-bold">(
                                {{
                                flight.legs[0]?.stops[0].departure.airport
                                ?.city_name
                                }}
                                to
                                {{
                                ...
                                <div>
                                    <div class="mb-0">
                                        <div v-for="(leg, legIndex) in flight.legs" :key="legIndex">
                                            <div v-for="(stop, index) in flight.legs[legIndex]
                                                ?.stops" :key=index
                                                class="relative bg-gradient-to-r from-rose-100/50 to-teal-100/50">
                                                <!-- <pre>{{ flight }}</pre> -->
                                                <!-- <pre>Departure Time: {{ stop.departure.time }}</pre>
                                        <pre>Departure Date:{{ flight?.dates[0]?.departureDate }}</pre> -->
                                                <!-- <pre>{{ adjustDateTime(flight?.dates[0]?.departureDate,
                                            stop.departure.time,
                                            stop.adjustment
                                        ) }}</pre> -->

                                                <!-- <pre>{{ adjustDateTime(flight?.dates[0]?.departureDate,
                                            stop.departure.time, stop.adjustment).formattedDate }}</pre>
                                              <pre>{{ adjustDateTime(flight?.dates[0]?.departureDate,
                                            stop.departure.time, stop.adjustment).formattedTime }}</pre> -->
                                                <div class="p-2 border-b-2 border-dashed">
                                                    <div class="grid grid-cols-3 gap-x-2">
                                                        <div class="text-start">
                                                            <div class="flex items-center gap-x-3">
                                                                <img class="w-4 h-4 rounded-full" :src="stop.airline
                                                                    .logo_url
                                                                    " alt="" />
                                                ...
                                                <div
                                                    ...
                                                    <Badge class="text-sm py-2" v-if="
                                                        flight.legs[legIndex]?.stops
                                                            .length -
                                                        1 >
                                                        index
                                                    ">
                                                        <span class="font-medium mr-1">{{ $t("layover") }}:</span>
                                    ...
                                    <!-- return flight -->
                                    <!-- <div v-for="(stop, index) in flight.legs[1]
                                    ?.stops" :key="stop.id"
                                    class="relative bg-gradient-to-r from-rose-100/50 to-teal-100/50">
                                    <div class="p-2 border-b-2 border-dashed">
                    ...
                    <div class="bg-gray-200 border border-primary mt-1 rounded-lg">
                        <div class="border-b p-4">
                            <span class="text-sm font-bold">Contact Information</span>
                        </div>
                        <div class="p-4">
                                    ...
                                    <Popover v-model:open="isOpenCountryDropdown">
                                        <PopoverTrigger as-child>
                                            <Button variant="outline" role="combobox"
                                                class="w-full justify-between py-3" :class="{
                                                    'is-invalid':
                                                        errors.mainContact.country,
                                                }">
                                                {{
                                        ...
                                        <PopoverContent class="w-full p-0">
                                            <Command>
                                                <CommandInput class="h-9" @input="fetchCountries"
                                                    placeholder="Search country..." />
                                                <CommandEmpty>No results found.</CommandEmpty>
                                                <CommandList>
                                                    <CommandGroup>
                                                        <CommandItem v-for="country in countries" :key="country.value"
                                                            :value="country.label" @select="
                                                                (ev) => {
                                                                    if (
                                                                        typeof ev
                                                                            .detail
                                                            ...
                                                            <img :src="`https://flagcdn.com/24x18/${country.code}.png`"
                                                                class="w-[18px] mr-1" :alt="`${country.label} flag`" />
                                                            {{ country.label }}
                                                            <Check :class="cn(
                                                                'ml-auto h-4 w-4',
                                                                mainContact.country ===
                            ...
                            <div>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 bg-white rounded-lg">
                                    ...
                                    <div>
                                        ...
                                        <Input type="email"
                                            class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring-primary"
                                            v-model="agencyContact.email" readonly />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="w-full mx-auto mt-1 rounded-lg">
                        <div class="p-2">
                            <p class="text-base font-medium">
                                Traveller Details
                                <span class="text-xs font-thin">(Use all given names and surnames exactly as
                                    they appear on your passport/ID to avoid
                                    complications.)</span>
                            </p>
                        ...
                        <div v-for="(traveller, index) in travellers" :key="`traveller-${index}`"
                            ...
                            <div class="p-4 bg-gray-50 rounded-lg">
                                ...
                                <div class="mt-2">
                                    <RadioGroup class="flex" default-value="comfortable" :orientation="'horizontal'"
                                        v-model="traveller.gender" :class="{
                                            'is-invalid': getErrorPath(
                            ...
                            <div class="p-4">
                                <div class="grid grid-cols-5 gap-4">
                                    <div class="mb-3">
                                        <Label :for="`title-${index}`"
                                            class="block text-sm font-medium text-gray-700 mb-1">Title<span
                                                class="required">*</span></Label>
                                        <Select v-model="traveller.title" :id="`title-${index}`" :class="{
                                            'is-invalid': getErrorPath(
                                                `travellers.${index}.title`,
                                            ),
                                        }">
                                            <SelectTrigger>
                                                <SelectValue placeholder="Select title" />
                                    ...
                                    <div class="mb-3">
                                        <Label :for="`date-of-birth-${index}`"
                                            class="block text-sm font-medium text-gray-700 mb-1">Date of birth<span
                                                v-if="traveller.type == 'ADT'" class="required">
                                                *Age Should be 12+</span>
                                            <span v-else-if="traveller.type == 'CNN'" class="required">
                                                *Age 2 to 12 years</span>
                                            <span v-if="traveller.type == 'INF'" class="required text-xs">
                                                *Age Less then 2</span>
                                        </Label>
                                        <Input v-model="traveller.dob" type="date" :id="`date-of-birth-${index}`"
                                            placeholder="Date Of Birth" :class="{
                                                'is-invalid': getErrorPath(
                                                    `travellers.${index}.dob`,
                                                ),
                                            }"
                                            class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring-primary" />
                                    ...
                                    <div class="mb-3">
                                        <Label :for="`nationality-${index}`"
                                            class="block text-sm font-medium text-gray-700 mb-1">Nationality<span
                                                class="required">*</span></Label>
                                        <Input maxLength="2" limit v-model="traveller.nationality"
                                            :id="`nationality-${index}`" type="text" :class="{
                                                'is-invalid': getErrorPath(
                                ...
                                <div class="grid grid-cols-4 gap-4">
                                    <div class="mb-3">
                                        <Label :for="`document-type-${index}`"
                                            class="block text-sm font-medium text-gray-700 mb-1">Doc Type<span
                                                class="required">*</span></Label>
                                        <Select v-model="traveller.documentType" :id="`document-type-${index}`" :class="{
                                            'is-invalid': getErrorPath(
                                                `travellers.${index}.documentType`,
                                            ),
                                        }">
                                            <SelectTrigger>
                                                <SelectValue placeholder="Select title" />
                                    ...
                                    <div class="mb-3">
                                        <Label :for="`document-no-${index}`"
                                            class="block text-sm font-medium text-gray-700 mb-1">Document No<span
                                                class="required">*</span></Label>
                                        <Input v-model="traveller.documentNo" :id="`document-no-${index}`" :class="{
                                            'is-invalid': getErrorPath(
                                                `travellers.${index}.documentNo`,
                                            ),
                                        }" type="text"
                                            class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring-primary"
                                            placeholder="Enter document number" />
                                    ...
                                    <div class="mb-3">
                                        <Label :for="`expiry-date-${index}`"
                                            class="block text-sm font-medium text-gray-700 mb-1">Expiry Date<span
                                                class="required">*</span></Label>
                                        <Input v-model="traveller.expiryDate" :id="`expiry-date-${index}`" :class="{
                                            'is-invalid': getErrorPath(
                                                `travellers.${index}.expiryDate`,
                                            ),
                                        }" type="date"
                                            class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring-primary" />
                                        <div v-if="
                                    ...
                                    <div class="mb-3">
                                        <Label :for="`issue-country-${index}`"
                                            class="block text-sm font-medium text-gray-700 mb-1">Issue Country<span
                                                class="required">*</span></Label>
                                        <Input v-model="traveller.issueCountry" :id="`issue-country-${index}`" :class="{
                                            'is-invalid': getErrorPath(
                                                `travellers.${index}.issueCountry`,
                                            ),
                                        }" type="text"
                ...
                <div class="bg-white w-1/4 p-4 border rounded-lg">
                                    ...
                                    <div class="flex justify-between items-center bg-gray-50 p-2 rounded">
                                        ...
                                        <div class="flex items-center">
                                            <span class="text-base font-bold text-primary">
                                                ...
                                                passenger
                                                .passengerTotalFare
                                                .totalTaxAmount * passenger.passengerNumber +
                                                parseFloat(
                                                agentData
                                                ?.agent_data
                                                ?.margin_amount * passenger.passengerNumber,
                    ...
                    <div>
                        <ul class="text-sm text-muted-foreground font-medium my-2 space-y-2">
                            <li class="flex items-center justify-between">
                                <!-- <pre>{{ flight.legs[0].stops[0].airline.margin_amount }}</pre> -->
                                <span>Total Base Fare</span>

                                <div class="hidden">{{passengerCount = (passengerCount =
                                    flight?.passengerInfo?.reduce((total, p) => total + p.passengerNumber, 0))}}
                                </div>
                            ...
                            <li class="flex items-center justify-between">
                                ...
                                <span>{{
                                    formatAmount(flight.pricing.totalTaxAmount || 0)
                                    }}</span>
                            </li>
                        ...
                        <div class="flex items-center gap-4 p-4">
                            <Input type="checkbox" v-model="termsAccepted" id="terms" class="" />
                        ...
                        <!-- saveBookingData -->
                        <!-- @click="saveBooking" -->
                        <Button @click="saveBooking" :disabled="!termsAccepted" class="w-full mt-3">{{
                ...
                <div class="space-y-6 text-sm text-gray-700 leading-relaxed">
                    ...
                    <div>
                        ...
                        <p class="space-y-2">
                            <span>1. For any amendments, cancellation, or ancillary services for flights, contact our
                                24x7 reservation team at
                                <a href="tel:+923111448111" class="underline hover:text-blue-700">+971 52 901 3757</a>
                                or email
                                <a href="mailto:support@Jetze.pk"
                                    class="underline hover:text-blue-700">support@Jetze.pk</a>.
                            </span><br>
                            <span>2. Any amendments will be subject to the airline's terms, penalties, and fare
                                differences.</span><br>
                            <span>3. Cancellation/refund will be handled on a case-by-case basis based on airline and
                    ...
                    <div>
                        <h3 class="text-base font-semibold mb-2">Supplier Message</h3>
    ...
    <div v-if="showPreview && !isLoading" class="flex flex-col min-h-screen bg-gray-50">
        ...
        <div class="bg-white border-b rounded-lg flex justify-between border-gray-200 p-4">
            <div>
                <h2 class="text-xl font-semibold text-gray-800">Booking Preview</h2>
                <p class="text-sm text-gray-600">Review your booking details below before confirming.</p>
            </div>
        ...
        <div class="flex flex-col lg:flex-row gap-6 ">
                    ...
                    <div v-for="(traveller, index) in travellers" :key="`traveller-${index}`"
                        ...
                        <div class="p-4">
                            <div class="flex items-center gap-3 mb-4">
                                ...
                                <h3 class="text-lg font-semibold text-gray-800">{{ traveller.type }} Traveller {{ index
                                    + 1 }}</h3>
                            </div>
                            <!-- Personal Information -->
                            <div class=" grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                                <div>
                                    ...
                                    <p class="text-sm text-gray-900">{{ traveller.gender === 'M' ? 'Male' :
                                        traveller.gender === 'F' ? 'Female' : 'Not provided' }}</p>
                                </div>
                                <div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-900">{{ traveller.expiryDate ?
                                        formatDate(traveller.expiryDate) : 'Not provided' }}</p>
                                </div>
                                <div>
                            ...
                            <div v-if="traveller.showAncillaries" class="mt-4">
                                ...
                                <div v-for="(flight, flightIdx) in flight?.leg?.flights" :key="flightIdx" class="mb-4">
                                    <p class="text-sm font-medium text-gray-700">{{ flight?.from?.city?.name }} to {{
                                        flight?.to?.city?.name }}</p>
                                    <div v-for="(segment, segmentIdx) in flight?.segments" :key="segmentIdx"
                                        class="ml-4">
                                        <p class="text-sm text-gray-600">Segment: {{ segment?.from?.name }} → {{
                                            segment?.to?.name }}</p>
                                        <div v-if="selectedExtras[flightIdx]?.baggage?.[segmentIdx]?.[index]">
                                            <p class="text-sm text-gray-900">Baggage: {{
                                                selectedExtras[flightIdx]?.baggage?.[segmentIdx]?.[index]?.title }} ({{
                                                selectedExtras[flightIdx]?.baggage?.[segmentIdx]?.[index]?.currency }}
                                                {{ selectedExtras[flightIdx]?.baggage?.[segmentIdx]?.[index]?.amount }})
                                            </p>
                                        ...
                                        <div v-if="selectedExtras[flightIdx]?.seat?.[segmentIdx]?.[index]">
                                            <p class="text-sm text-gray-900">Seat: {{
                                                selectedExtras[flightIdx]?.seat?.[segmentIdx]?.[index]?.title }} ({{
                                                selectedExtras[flightIdx]?.seat?.[segmentIdx]?.[index]?.currency }} {{
                                                selectedExtras[flightIdx]?.seat?.[segmentIdx]?.[index]?.amount }})</p>
                                        </div>
                                        <div v-if="selectedExtras[flightIdx]?.meal?.[segmentIdx]?.[index]">
                                            <p class="text-sm text-gray-900">Meal: {{
                                                selectedExtras[flightIdx]?.meal?.[segmentIdx]?.[index]?.title }} x{{
                                                selectedExtras[flightIdx]?.meal?.[segmentIdx]?.[index]?.qty || 1 }} ({{
                                                selectedExtras[flightIdx]?.meal?.[segmentIdx]?.[index]?.currency }} {{
                                                selectedExtras[flightIdx]?.meal?.[segmentIdx]?.[index]?.amount }})</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="w-full lg:w-2/5 space-y-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div class="space-y-2">
                                    ...
                                    <div class="space-y-1">
                                        ...
                                        <div class="text-xs text-gray-500">{{ segment?.from?.name }} ({{
                                            segment?.from?.iata }})</div>
                                        <div class="text-xs text-gray-400">Terminal: {{ segment?.from_terminal[0] ??
                                            "N/A" }}</div>
                                    </div>
                                </div>
                                <div class="flex items-center justify-center">
                                ...
                                <div class="space-y-2 text-right">
                                    <div class="space-y-1">
                                        <div class="text-sm font-medium text-gray-900">{{
                                            formatDate(segment?.arrival_at) }}</div>
                                        <div class="text-xs text-gray-500">{{ segment?.to?.name }} ({{ segment?.to?.iata
                                            }})</div>
                                        <div class="text-xs text-gray-400">Terminal: {{ segment?.to_terminal[0] ?? "N/A"
                                            }}</div>
                                    </div>
                ...
                <div class="bg-white border border-gray-200 rounded-lg shadow-sm">
                    <div class="p-4">
                                ...
                                <div v-for="(fare, fareIndex) in flight?.fares" :key="fareIndex">
                                    <div v-if="selectedFares?.includes(fare.ref_id)" class="p-4 space-y-2">
                                        <div class="flex justify-between items-center">
                                            <span class="text-sm text-gray-600">Base Fare</span>
                                            <span class="text-sm font-medium">{{
                                                formatAmount(calculateFinalPrice(fare?.base_price, fare?.margin_amount,
                                                fare?.margin_type, fare?.amount_type) +
                                                parseFloat((agentData?.agent_data?.margin_amount *
                                                route.query.passenger_count)) + agentMargin) }}</span>
                                        </div>
                                        <div class="flex justify-between items-center">
                                            <span class="text-sm text-gray-600">Taxes</span>
                                            <span class="text-sm font-medium">{{ formatAmount(calculateTaxes(fare))
                                                }}</span>
                                        </div>
                                        <div v-if="ancillaries" class="flex justify-between items-center">
                                            <span class="text-sm text-gray-600">Add-ons</span>
                                            <span class="text-sm font-medium">{{ formatAmount(
                                                ["baggage", "seat", "meal"].reduce((sum, group) => {
                                                const extras = extraCharges[flightIndex]?.[group] || {};
                                                const groupTotal = Object.values(extras).reduce((gSum, segmentGroup) =>
                                                {
                                                if (!segmentGroup) return gSum;
                                                return gSum + Object.values(segmentGroup).reduce((sSum, item) => {
                                                const price = item.price || item.amount || 0;
                                                const qty = item.qty || 1;
                                                return sSum + (price * qty);
                                                }, 0);
                                                }, 0);
                                                return sum + groupTotal;
                                                }, 0)
                                        ...
                                        <div class="flex justify-between items-center bg-gray-50 p-3 rounded-lg">
                                            ...
                                            <span class="text-base font-bold text-primary">{{ formatAmount(
                                                calculateTotalFare(fare) +
                                                ["baggage", "seat", "meal"].reduce((sum, group) => {
                                                const extras = extraCharges[flightIndex]?.[group] || {};
                                                const groupTotal = Object.values(extras).reduce((gSum, segmentGroup) =>
                        ...
                        <div class="flex justify-between items-center bg-gray-50 p-3 rounded-lg mt-4">
                            ...
                            <span class="text-lg font-bold text-primary">{{ formatAmount(calculateGrandTotal())
                                }}</span>
                        </div>
                    </div>
                </div>
                <div class="space-y-2">
                    ...
                    <!-- Payment Methods -->
                    <div v-if="isPaymentMethodsVisible" class="grid grid-cols-2 gap-2 p-2 sm:p-3 bg-gray-50 rounded-lg">
                        <div v-if="agentData.is_card_allowed" @click="handlePaymentMethod('card')"
                            ...
                            <img src="/public/assets/credit-card.png" width="20" height="20" alt="Credit Card"
                                class="w-5 h-5 sm:w-10 sm:h-12" />
            ...
            <div class="bg-white max-w-3xl w-full rounded-lg p-6 shadow-lg overflow-y-auto max-h-[80vh]">
                ...
                <div class="space-y-6 text-sm text-gray-700 leading-relaxed">
                    ...
                    <div>
                        ...
                        <p class="space-y-2">
                            <span>1. For any amendments, cancellation, or ancillary services for flights, contact our
                                24x7 reservation team at <a href="tel:+923111448111"
                                    class="underline text-blue-500 hover:text-blue-700">+971 52 901 3757</a> or email <a
                                    href="mailto:support@Jetze.pk"
                                    class="underline text-blue-500 hover:text-blue-700">support@Jetze.pk</a>.</span><br>
                            <span>2. Any amendments will be subject to the airline's terms, penalties, and fare
                                differences.</span><br>
                            <span>3. Cancellation/refund will be handled on a case-by-case basis based on airline and
                                agency policies.</span>
                ...
                <div class="mt-6 text-right">
                    <button @click="closeTermsDialog"
                        class="bg-primary text-white px-4 py-2 rounded-sm hover:bg-primary/80">Close</button>
                </div>
            </div>
        </div>
        ...
        <div v-if="isLowBalanceDialogOpen"
            ...
            <div class="bg-white rounded-lg shadow-xl max-w-md w-full p-6">
                ...
                <p class="text-sm text-gray-600 mb-6">Your balance is insufficient to confirm this booking. Please add
                    funds to your account.</p>
                <div class="flex justify-end space-x-3">
                    <button @click="isLowBalanceDialogOpen = false"
                        class="px-4 py-2 bg-white border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50">Cancel</button>
                    <button @click="$router.push({ name: 'Deposits' })"
                        class="px-4 py-2 bg-primary text-white rounded-lg text-sm font-medium hover:bg-primary/20">Go To
                        Deposit</button>
                </div>
            </div>
        </div>
            ...
            <div class="bg-white rounded-lg shadow-xl max-w-md w-full p-6">
                ...
                <div class="flex justify-end space-x-3">
                    <button @click="isConfirmDialogOpen = false"
                        class="px-4 py-2 bg-white border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50">Cancel</button>
                    <button @click="saveBooking"
                        class="px-4 py-2 bg-primary text-white rounded-lg text-sm font-medium hover:bg-primary/20">Confirm
                        Booking</button>
                </div>
            </div>
        </div>
    ...
    <div v-if="isOpen && !apiErrors"
        class="fixed inset-0 bg-black/20 backdrop-blur-sm flex items-center justify-center z-30 p-4">
        <div
