                            ...
                            <div>
                                <div class="overflow-x-auto">
                                    ...
                                    <table
                                        ...
                                        <tbody v-if="pnrDetails" class="divide-y divide-gray-100 ">
                                        ...
                                        <tbody v-else class="divide-y divide-gray-100 ">
                                            <template
                                                ...
                                                <tr v-for="(fare, fareIndex) in flight.fares.filter(f => {
                                                    ...
                                                    <td class="py-1.5 px-2 uppercase">
                                                        {{  total = (billable + (agentAmount * passengerCount) + margin - (agentDiscount * passengerCount) + (airportMargin * passengerCount) + (parseFloat(bookingDetails?.[0]?.airport_margin_amount || 0) * passengerCount)  + margin) }}
                                                    </td>
                                                    <td class="py-1.5 px-2 uppercase">
