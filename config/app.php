...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | The frontend URL of your application. This is used to generate links
    | to the frontend application, for example in email verification links.
    |
    */
