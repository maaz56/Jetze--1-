...
<template>
    <div class="min-h-screen bg-gray-50 rtl:text-right">
        <!-- Hero Section -->
        <section
            class="bg-[url('/public/assets/Saudi2.jpg')] relative bg-primary text-white py-24"
        >
            <div class="container mx-auto px-4 text-center">
                ...
                <p
                    class="text-lg md:text-xl max-w-2xl mx-auto mb-8 z-50 relative"
                >
                    Enter your booking reference and email to view or manage
                    your trip
                </p>

                <form
                    class="bg-white rounded-xl p-8 max-w-2xl mx-auto shadow-lg border z-30 relative"
                >
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            <input
                                ...
                                class="w-full px-5 py-3 border border-gray-300 rounded-md text-gray-800 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent text-base uppercase tracking-wider placeholder:tracking-normal"
                            />
                            <label
                                class="text-xs text-red-600"
                                v-if="refCodeError"
                                >*Please enter PNR.</label
                            >
                        </div>
                        ...
                        <div>
                            <input
                                ...
                                class="w-full px-5 py-3 border border-gray-300 rounded-md text-gray-800 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent text-base"
                            />
                            <label
                                class="text-xs text-red-600"
                                v-if="emailError"
                        ...
                        <div class="flex items-center">
                            <button
                                @click.prevent="findBooking"
                                class="w-full bg-primary hover:bg-primary/90 text-white font-semibold py-3 px-6 rounded-md flex items-center justify-center gap-3 transition-all duration-200 shadow-md hover:shadow-lg"
                            >
            ...
            <div class="container mx-auto px-4">
                <div class="bg-white rounded-2xl overflow-hidden">
                    ...
                    <div class="overflow-x-auto">
                        ...
                        >
                            <thead
                                class="text-xs uppercase bg-gray-100 text-gray-700"
                            >
                                <tr>
                            ...
                            <tbody class="divide-y divide-gray-200">
                                ...
                                >
                                    ...
                                    <td class="px-6 py-4">
                                        <div
                                            v-for="p in booking.pessangers ||
                                            []"
                                            :key="p.id"
                                            class="text-sm"
                                        >
                                            {{ p.title }} {{ p.first_name }}
                                            {{ p.last_name }}
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <template
                                            v-if="booking.booking_source == 1"
                                        >
                                            <div
                                                v-for="(
                                                    f, i
                    ...
                    <section class="px-6 py-16 bg-gray-100/60">
                        <div class="mx-auto max-w-7xl">
                            <div
                                class="grid grid-cols-1 md:grid-cols-3 gap-10 lg:gap-16 text-center"
                            >
                                ...
                                <div class="flex flex-col items-center group">
                                    ...
                                    <h3
                                        class="text-xl md:text-2xl font-bold text-gray-800 mt-4"
                                    >
                                        24/7 Customer Support
                                    </h3>
                                    <p
                                    ...
                                    >
                                        We're always here to help, any time of
                                        day or night
                                    </p>
                                </div>
                                ...
                                <div class="flex flex-col items-center group">
                                    ...
                                    <p
                                        class="text-gray-600 mt-2 text-sm md:text-base"
                                    >
                                        Quick and hassle-free refund processing
                                        guaranteed
                                    </p>
                                </div>
                                ...
                                <div class="flex flex-col items-center group">
                                    ...
                                    <p
                                        class="text-gray-600 mt-2 text-sm md:text-base"
                                    >
                                        Your payments are 100% safe and
                                        encrypted
                                    </p>
                                </div>
                            </div>
