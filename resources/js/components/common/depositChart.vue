<template>
    <div class="relative bg-white w-full p-4 rounded-xl">
      ...
      <div class="flex flex-col md:flex-row items-center justify-between">
        ...
        <div class="w-full  lg:w-1/2 pl-2 max-sm:pl-0 mt-6 lg:mt-0">
          <div class="pl-8 max-lg:grid max-lg:grid-cols-2 gap-4 max-lg:pl-0">
            <div class="w-full flex items-center p-2 bg-gradient-to-r from-blue-50 to-blue-100 rounded-lg transform transition-all duration-300 hover:translate-y-[-2px] hover:shadow-md">
              <span class="flex items-center justify-center w-10 h-10 bg-blue-500 rounded-full mr-3 max-[320px]:hidden">
            ...
            <div class=" w-full flex items-center p-3 bg-gradient-to-r from-green-50 to-green-100 rounded-lg transform transition-all duration-300 hover:translate-y-[-2px] hover:shadow-md">
              <span class="flex items-center justify-center w-10 h-10 bg-green-500 rounded-full mr-3 max-[320px]:hidden">
            ...
            <div class="w-full flex items-center p-3 bg-gradient-to-r from-yellow-50 to-yellow-100 rounded-lg transform transition-all duration-300 hover:translate-y-[-2px] hover:shadow-md">
              <span class="flex items-center justify-center w-10 h-10 bg-yellow-500 rounded-full mr-3 max-[320px]:hidden">
                <span class="text-white font-bold">⏱</span>
              </span>
              <div>
            ...
            <div class="w-full flex items-center p-3 bg-gradient-to-r from-red-50 to-red-100 rounded-lg transform transition-all duration-300 hover:translate-y-[-2px] hover:shadow-md">
              <span class="flex items-center justify-center w-10 h-10 bg-red-500 rounded-full mr-3 max-[320px]:hidden">
                <span class="text-white font-bold">✕</span>
              </span>
              <div>
  ...
  const normalizedDeposits = computed(() => ({
      totalDeposits: toAmount(props.deposits?.totalDeposits),
      totalApprovedDeposits: toAmount(props.deposits?.totalApprovedDeposits),
      totalPendingDeposits: toAmount(props.deposits?.totalPendingDeposits),
      totalRejectedDeposits: toAmount(props.deposits?.totalRejectedDeposits),
  }))
      ...
      datasets: [
          {
              data: [
                ...
                normalizedDeposits.value.totalApprovedDeposits,
                normalizedDeposits.value.totalPendingDeposits,
                normalizedDeposits.value.totalRejectedDeposits,
              ],
  ...
  const calculatePercentage = computed(() => {
      ...
      const ticketed = normalizedDeposits.value.totalApprovedDeposits
      if (total === 0) return 0
