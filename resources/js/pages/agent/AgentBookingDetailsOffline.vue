...
<template>
            ...
            <div v-if="route?.query?.booking_source == 1">
                ...
                <div id="print-section">
                    <div v-for="booking in bookingDetails" :key="booking.id"
                        ...
                        <div class="relative grid grid-cols-8 justify-between h-48 bg-gradient-to-r from-primary/80 to-primary items-center 
                    print:bg-white print:border-b-2 print:border-primary">
                            ...
                            <div class="col-span-5 text-white ps-4 print:text-black border-l-2 print:border-gray-800">
                                ...
                                <p class="line-clamp-2">
                                    {{
                                        ...
                                        "F-16 AliZai Tower,Sheikhpura Road,Lahore,Pakistan"}}
                                </p>
                                <p class="">
                                    {{
                            ...
                            <div
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    ...
                                    <p class="font-semibold">{{ agentData.agent_data?.agent_uid }}_{{ booking.id +1000 }}</p>
                                </div>
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    ...
                                    <p class="font-semibold" v-if="!sooperResponse?.data?.booking?.booking.providers">
                        ...
                        <div class="p-6 border-b border-gray-200">
                            ...
                            <div v-if="parseFlightData(booking.flight_data)?.original?.leg || parseFlightData(booking.flight_data)?.leg" class="space-y-3">
  <div
  ...
  >
                    ...
                    <div class="p-6 border-b border-gray-200 bg-white" v-for="booking in bookingDetails"
                        ...
                        <div v-if="sooperResponse?.data?.booking?.booking?.providers" class="space-y-4">
                            <div v-for="(flight, flightIndex) in sooperResponse?.data?.booking?.booking?.providers[0]?.legs"
                                :key="flightIndex" class="overflow-x-auto">
                                ...
                                <table
                                    ...
                                    <thead>
                                        <tr class="bg-gray-50">
                                            <th class="py-1.5 px-2 text-left font-medium text-gray-600">Traveller Name
                                            </th>
                                    ...
                                    <tbody v-for="(passenger, index) in flight?.passengers" :key="index"
                                        ...
                                        <tr class="hover:bg-gray-50 transition-colors">
                                            <td class="py-1.5 px-2 uppercase">
                                                ...
                                                <span class="text-gray-500 text-xs ml-1">({{
                                                    passenger?.passenger?.traveler_type }})</span>
                                            </td>


                                            <td class="py-1.5 px-2 uppercase">{{
                                                passenger?.passenger?.gender?.toUpperCase() }}</td>

                                            <td class="py-1.5 px-2">
                                                {{ passenger?.passenger?.nationality?.alpha_2 }}
                                            </td>
                    ...
                    <div class="p-6 border-b border-gray-200" v-if="isDetailsInfoVisible">
                        ...
                        <div v-for="booking in bookingDetails" :key="booking.id">
                            ...
                            <div class="overflow-x-auto"
                                v-for="(flight, flightIndex) in pnrData?.data?.providers[0]?.legs" :key="flightIndex">
                                ...
                                <table
                                    ...
                                    <tbody class="divide-y divide-gray-100 "
                                        ...
                                        <tr class="hover:bg-gray-50">
                                            <td class="py-1.5 px-2 uppercase">{{
                                                passenger?.passenger?.traveler_type }}</td>

                                            <td class="py-1.5 px-2 uppercase">
                                                {{ formatAmount(calculatePassengerFare(passenger, flightIndex)) }}
                                            </td>
                                            <!-- <pre>{{ pnrData?.data }}</pre> -->

                                            <td class="py-1.5 px-2 uppercase">
                                                {{ formatAmount(
                                                    parseFloat(passenger.fee) +
                                                    parseFloat(passenger.taxes || 0) + parseFloat(passenger?.surcharge || 0)
                                                    + parseFloat(
                                                        passenger?.service_charges || 0) + parseFloat(
                                                            passenger?.ancillaries_charges || 0)
                                                ) }}
                                            </td>

                                            <td class="py-1.5 px-2 uppercase font-bold">{{ formatAmount(
                                                calculatePassengerFinalFare(passenger,flightIndex)) }} </td>
                                        </tr>
                            ...
                            <div class="w-full text-xs border-2 border-gray-300 print:border-gray-400 mt-2">
                                <div class="flex bg-gray-100 font-semibold">
                                    <div class="py-2 px-2 uppercase w-1/4  border-gray-300">TOTAL</div>
                                    <div class="py-2 px-2 uppercase w-1/4  border-gray-300">{{ }}</div>
                                    <div class="py-2 px-2 uppercase w-1/4  border-gray-300"></div>
                                    <div class="py-2 px-2 uppercase w-1/4  border-gray-300 hidden">
                                        <pre>{{ totalTicketPrice = parseFloat(pnrData?.data?.billable_price || 0) }}</pre>
                                    </div>

                                    <div class="py-2 px-2 uppercase font-bold text-green-700 w-1/4 ">
                                        {{
                                            formatAmount(calculatePnrFinalFare())
                    ...
                    print:bg-white print:border-b-2 print:border-green-800">
                        ...
                        <div class="p-6 border-b border-gray-200">
                            ...
                            <div v-if="parseFlightData(booking.flight_data)" class="space-y-3">
                              <div 
  v-for="(leg, legIndex) in (parseFlightData(booking.flight_data)?.original?.legs ?? parseFlightData(booking.flight_data)?.legs)" 
  :key="legIndex" 
  class="space-y-2"
>
