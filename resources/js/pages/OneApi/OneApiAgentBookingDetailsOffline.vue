                            ...
                            <div class="col-span-5 text-white ps-4 print:text-black border-l-2 print:border-gray-800">
                                ...
                                <p class="line-clamp-2">
                                    {{
                                        ...
                                        "65-B Gulfishan Town,14 km,Sheikhpura Road,Lahore,Pakistan"}}
                                </p>
                                <p class="">
                                    {{
                        ...
                        <div>
                            <div class="overflow-x-auto">
                                <table
                                    ...
                                    <tbody v-if="pnrData?.Body?.OTA_AirBookRS?.AirReservation?.PriceInfo" class="divide-y divide-gray-100 ">
                                        <tr class="hover:bg-gray-50">

                                            <td class="py-1.5 px-2 uppercase">
                                                {{ formatAmount(
                                                    calculateFinalPrice(
                                                         pnrData?.Body?.OTA_AirBookRS?.AirReservation?.PriceInfo?.ItinTotalFare?.EquiBaseFare?.['@attributes']?.Amount,
                                                        fare?.margin_amount,
                                                        fare?.margin_type,
                                                        fare?.amount_type || 0
                                                    )
                                            ...
                                            <td class="py-1.5 px-2 uppercase">
                                                {{ formatAmount( parseFloat(pnrData?.Body?.OTA_AirBookRS?.AirReservation?.PriceInfo?.ItinTotalFare?.Taxes?.Tax?.['@attributes']?.Amount) + parseFloat(pnrData?.Body?.OTA_AirBookRS?.AirReservation?.PriceInfo?.ItinTotalFare?.Fees?.Fee?.['@attributes']?.Amount) ) }}
                                            </td>
                                            <td class="py-1.5 px-2 uppercase font-bold">
                                                {{ formatAmount(
                                                    parseFloat(pnrData?.Body?.OTA_AirBookRS?.AirReservation?.PriceInfo?.ItinTotalFare?.TotalEquivFareWithCCFee?.['@attributes']?.Amount|| 0)
                                                    + (
                                                        (parseFloat(bookingDetails?.[0]?.agent_markup || 0)
                                                            + parseFloat(bookingDetails?.[0]?.agent_margin || 0)
                                                            - parseFloat(bookingDetails?.[0]?.agent_discount || 0))
