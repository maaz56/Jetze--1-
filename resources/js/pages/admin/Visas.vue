...
function saveHeaderImages() {
    store
        .dispatch("visa/" + SAVE_VISA_HEADER_IMAGES, {
    ...
    <section>
        <div>
            <div class="flex items-center justify-between my-8">
                <span class="text-3xl font-medium">Visas</span>
                ...
                <div class="flex gap-2">
                    ...
                    <Button @click="$router.push({ name: 'NewVisa' })"
                        >New Visa</Button
                    >
                </div>
            </div>
            <div
                class=" dark:bg-gray-800 relative sm:rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700"
            >
                <div
                    ...
                    >
                            ...
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3">Country</th>
                                 <th scope="col" class="px-4 py-3">Currency</th>
                                    <th scope="col" class="px-4 py-3">Starting Price</th>
                        ...
                        <tbody>
                            ...
                            >
                                ...
                                <td class="px-4 py-3">{{ visa.title }}</td>
                                 <td class="px-4 py-3">{{ visa.country_name }}</td>
                                  <td class="px-4 py-3">{{ visa.currency }}</td>
                                      <td class="px-4 py-3">{{ visa.starting_price }}</td>
                                <td class="px-4 py-3">
