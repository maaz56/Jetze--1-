...
function fetchPnrDetails() {
    ...
    try {
        ...
        //pnrLive.value = pnrDetails?.bookingId ? pnrDetails?.bookingId : booking?.pnr || "-";
        //console.log("PNR Details:", pnrDetails.value);
            ...
            <div v-else>
                ...
                <div v-if="route?.query?.booking_source == 1">
                    ...
                    >
                        ...
                        <button :disabled="['canceled', 'issued', 'ticketed', 'voided'].includes(booking?.status.toLowerCase())" @click="isDialogOpen = true"
                            class="px-4 py-2 text-sm font-medium text-white bg-primary rounded-md hover:bg-primary/50 disabled:cursor-not-allowed">
                            Cancel Booking
                        </button>
                            ...
                            <div v-if="sooperResponse?.data?.booking?.booking?.providers" class="space-y-4">
                                <div v-for="(flight, flightIndex) in sooperResponse?.data?.booking?.booking?.providers[0]?.legs"
                                    ...
                                    <table
                                        ...
                                        <thead>
                                            <tr class="bg-gray-50">
                                                <th class="py-1.5 px-2 text-left font-medium text-gray-600">Traveller
                                                    Name</th>
                                                ...
                                                <th class="py-1.5 px-2 text-left font-medium text-gray-600">Ticket No
                                                </th>
                        ...
                        <div class="p-6 border-b border-gray-200" v-if="isDetailsInfoVisible">
                            ...
                            <div v-for="booking in bookingDetails" :key="booking.id">
                                ...
                                <div class="overflow-x-auto"
                                    v-for="(flight, flightIndex) in pnrData?.data?.providers[0]?.legs"
                                    :key="flightIndex">
