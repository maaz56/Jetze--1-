                                    ...
                                    <tbody v-for="(passenger, index) in flight?.passengers" :key="index"
                                        ...
                                        <tr class="hover:bg-gray-50 transition-colors">
                                            <td class="py-1.5 px-2 uppercase">
                                                {{ passenger?.passenger?.title }} {{ passenger?.passenger?.last_name }}
                                ...
                                <table
                                    ...
                                    <tbody class="divide-y divide-gray-100 "
                                        ...
                                        <tr class="hover:bg-gray-50">
                                            ...
                                            <td class="py-1.5 px-2 uppercase">
                                                {{ formatAmount(parseFloat(passenger.base_price) + parseFloat(
                                                    agentData?.agent_data?.margin_amount || 0)) }}
                                            </td>
                                            <td class="py-1.5 px-2 uppercase">
                                                {{ formatAmount(
                                            ...
                                            <td class="py-1.5 px-2 uppercase font-bold">{{ formatAmount(
                                                parseFloat(passenger.total_price) +
                                                parseFloat(agentData?.agent_data?.margin_amount || 0)) }} </td>
                                        </tr>
                                    ...
                                    <div class="py-2 px-2 uppercase font-bold text-green-700 w-1/4 ">
                                        {{
                                            formatAmount(
                                                ...
                                                parseFloat(pnrData?.data?.billable_price || 0) +
                                                parseFloat(agentData?.agent_data?.margin_amount || 0) *
                                                parseFloat(pnrData?.data?.providers[0]?.legs.length) *
                                                parseFloat(pnrData?.data?.providers[0]?.legs[0]?.passengers.length || 0))
