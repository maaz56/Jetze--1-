<template>
  <aside
    ...
    <div class="p-4 border-b border-gray-100 bg-white/30">
      <router-link :to="{ name: 'ReservationUsers' }" class="flex items-center space-x-3">
      ...
      <div class="space-y-1 px-3">
        <!-- <router-link :to="{ name: 'Dashboard' }"
          class="flex items-center px-3 py-2 text-sm rounded-lg transition-colors duration-200" :class="{
            'bg-white/30 text-gray-700 font-medium': $route.name === 'Dashboard',
            'text-gray-700 hover:bg-white/20 hover:text-gray-900': $route.name !== 'Dashboard'
          }">
          <LayoutDashboard class="w-5 h-5 mr-3 flex-shrink-0"
            :class="$route.name === 'SalesmanDashboard' ? 'text-gray-600' : 'text-gray-500'" />
          Dashboard
        </router-link> -->

        <!-- <router-link :to="{ name: 'Bookings' }"
          class="flex items-center px-3 py-2 text-sm rounded-lg transition-colors duration-200" :class="{
            'bg-white/30 text-gray-700 font-medium': $route.name === 'Bookings',
            'text-gray-700 hover:bg-white/20 hover:text-gray-900': $route.name !== 'Bookings'
          }">
          <Notebook class="w-5 h-5 mr-3 flex-shrink-0"
            :class="$route.name === 'Bookings' ? 'text-gray-600' : 'text-gray-500'" />
          Bookings
        </router-link>
        <router-link :to="{ name: 'VoidBookings' }"
          class="flex items-center px-3 py-2 text-sm rounded-lg transition-colors duration-200" :class="{
            'bg-white/30 text-gray-700 font-medium': $route.name === 'VoidBookings',
            'text-gray-700 hover:bg-white/20 hover:text-gray-900': $route.name !== 'VoidBookings'
          }">
          <Notebook class="w-5 h-5 mr-3 flex-shrink-0"
            :class="$route.name === 'VoidBookings' ? 'text-gray-600' : 'text-gray-500'" />
          Void Bookings
        </router-link>
        <router-link :to="{ name: 'DirectBookings' }"
          class="flex items-center px-3 py-2 text-sm rounded-lg transition-colors duration-200" :class="{
            'bg-white/30 text-gray-700 font-medium': $route.name === 'DirectBookings',
        ...
        <router-link :to="{ name: 'ImportPnr' }"
          class="flex items-center px-3 py-2 text-sm rounded-lg transition-colors duration-200" :class="{
            'bg-white/30 text-gray-700 font-medium': $route.name === 'ImportPnr',
            'text-gray-700 hover:bg-white/20 hover:text-gray-900': $route.name !== 'ImportPnr'
          }">
          <Ticket class="w-5 h-5 mr-3 flex-shrink-0"
            :class="$route.name === 'ImportPnr' ? 'text-gray-600' : 'text-gray-500'" />
          Import PNRs
        </router-link> -->
      </div>
...
const menuSections = [
  {
    title: "Agent / Users",
    items: [
      { name: "Agents", to: { name: "ReservationUsers" }, icon: Users },
      // { name: "New Agent", to: { name: "NewReservationUser" }, icon: UserPlus },
    ],
  },
  // {
  //   title: "Finance",
