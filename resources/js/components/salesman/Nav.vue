...
<template>
    <header class="sticky top-0 z-50 w-full shadow-lg">
        <div class="relative bg-gradient-to-r from-[#a89666] to-[#dbcaa4]0 overflow-hidden">
            <!-- Animated clouds -->
                            ...
                            <Sheet>
                                ...
                                <SheetContent side="right" class="w-64 sm:w-80 bg-black/90 border-l border-white/30">
                                    ...
                                    <nav class="flex flex-col gap-2 mt-4 sm:mt-6">
                                        <Button variant="ghost" class="justify-start text-sm sm:text-base hover:bg-white/20 text-white py-2">
