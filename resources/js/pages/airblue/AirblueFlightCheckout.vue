...
const initializeTravellers = () => {
    ...
    travellers.value = passengerFares.flatMap((fare) => {
       ...
       const type =
    fare.traveler_type === "adt" || fare.traveler_type === "ADT"
        ? "ADT"
        : fare.traveler_type === "cnn" || fare.traveler_type === "chd" || fare.traveler_type === "CHD"
            ? "CHD"
            : fare.traveler_type === "inf" || fare.traveler_type === "INF"
                ? "INF"
        ...
        return Array(count)
            ...
            .map(() => ({
                ...
                gender: "",
                showAncillaries: false, // New property to control ancillaries visibility
            }));
    });
                                                ...
                                                <CommandList>
                                                    <CommandGroup>
                                                        <CommandItem v-for="country in countries" :key="country.value"
                                                            ...
                                                            ">
                                                             <img :src="`https://flagcdn.com/24x18/${country.code}.png`" class="w-[18px] mr-1" :alt="`${country.label} flag`"/>
                                                            {{ country.label }}
                                                            <Check :class="cn(
                                                                'ml-auto h-4 w-4',
                                                                mainContact.country ===
      ...
      <div class="bg-white max-w-3xl w-full rounded-lg p-6 shadow-lg overflow-y-auto max-h-[80vh]">
        ...
        <div class="space-y-6 text-sm text-gray-700 leading-relaxed">
          ...
          <div>
            <h3 class="text-base font-semibold mb-2">Amendment & Cancellation</h3>
            <p class="space-y-2">
              <span>1. For any amendments, cancellation, or ancillary services for flights, contact our 24x7 reservation team at <a href="tel:+923111448111" class="underline text-blue-500 hover:text-blue-700">+971 52 901 3757</a> or email <a href="mailto:support@Jetze.pk" class="underline text-blue-500 hover:text-blue-700">support@Jetze.pk</a>.</span><br>
              <span>2. Any amendments will be subject to the airline's terms, penalties, and fare differences.</span><br>
