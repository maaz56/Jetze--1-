                            ...
                            <div v-for="(flight, index) in flightData?.leg?.flights" :key="index" class="mb-6">
                                ...
                                <div v-for="(segment, sIndex) in flight?.segments" :key="sIndex" class="mb-4">
                                    <div class="text-xs font-semibold text-gray-700 mb-2">
                                        ...
                                        )" :key="cIndex" class="ml-2 text-primary text-xs font-medium">
                                            | {{ code.booking_code }}
                                        </span>
                                    </div>
                                    ...
                                    <table
                                        ...
                                        <tbody class="divide-y divide-gray-100">
                                            ...
                                            <template v-for="(fare, fIndex) in flight?.fares" :key="fIndex">
                                                <template
                                                    v-if="parseData(bookingDetails?.[0]?.fare_reference)?.includes(fare?.ref_id)">
                                                        ...
                                                        <td class="py-1.5 px-2 uppercase">
                                                            {{
                                                                fare.baggage_policies.find(
                                                                    bp => bp.traveler_type === travelerType && bp.type ===
                                                                        'checked'
                                                                )?.description || 'N/A'
                                                            }}
                                                        </td>
