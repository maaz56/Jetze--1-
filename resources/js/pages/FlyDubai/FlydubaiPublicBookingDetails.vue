            ...
            <div v-if="route?.query?.booking_source == 1">
                ...
                <div id="print-section">
                    ...
                    <div class="p-6 border-b border-gray-200" v-if="isDetailsInfoVisible">
                        ...
                        <div v-for="booking in bookingDetails" :key="booking.id">
                            <div class="overflow-x-auto" v-for="(flight, flightIndex) in pnrDetails?.flights"
                                :key="flightIndex">
                            ...
                            <div class="w-full text-xs border-2 border-gray-300 print:border-gray-400 mt-2">
                                <div class="flex bg-gray-100 font-semibold">
                                    ...
                                    <div class="py-2 px-2 uppercase w-1/4 border-gray-300">
                                        {{ formatAmount(parseFloat(pnrDetails?.fares[0]?.totals?.subtotal || 0) +
                                    ...
                                    <div class="py-2 px-2 uppercase w-1/4 border-gray-300">
                                        {{ formatAmount(parseFloat(pnrDetails?.fares[0]?.totals?.taxes || 0)) }}
                                    </div>
                                    <div class="py-2 px-2 uppercase font-bold text-green-700 w-1/4">
                                        {{ formatAmount(parseFloat(pnrDetails?.fares[0]?.totals?.total || 0) +
                                            parseFloat(calculateCustomerMargin(
                                                pnrDetails?.fares[0]?.totals?.subtotal,
                                                CustomerMargin?.value?.discount || 0,
                                                CustomerMargin?.value?.margin_amount || 0,
