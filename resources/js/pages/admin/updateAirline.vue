...
<template>
    <div>
        <div class="my-8">
            ...
            <span class="text-3xl font-medium">Update Airline</span>
        </div>
        <div class="bg-white rounded-lg p-4">
            <div class="">
                <form class="max-w-xs mx-auto p-4">
                    ...
                    <div class="mb-3">
                        <Label for="name">ICAO Code:</Label>
                        <Input type="text" placeholder="Enter ICAO Code:" id="ICAO Code:" />
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <Input type="text" placeholder="Enter Logo URL:" id="Logo URL:" />
                    </div>
                    <div class="mb-3">
                        <Label for="name">Carrier Condition URL:</Label>
                        <Input type="text" placeholder="Enter Carrier Condition URL:" id="Carrier Condition URL:" />
                    </div>
                    <div class="mb-3">
                        <Label for="logo">Airline Logo</Label>
                        <Input type="file" placeholder="Enter your website" id="logo" />
                    </div>
                    <div>
