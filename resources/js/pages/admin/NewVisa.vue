...
import { FETCH_COUNTRIES, SAVE_VISA, FETCH_CURRENCIES } from "@/services/store/actions.type";
...
<template>
    <div>
        <div class="my-8">
            ...
            <span class="text-3xl font-medium">New Visa</span>
        </div>
        <form @submit.prevent="saveVisa" class="bg-white rounded-lg p-4">
            <div class="mb-3">
                <Label for="header-image">
                    Header Image
                    <span class="ml-2 text-sm text-muted-foreground">1920 × 360 banner</span>
                </Label>
                <FileUploader
                    id="header-image"
                    max-files="1"
                    accept="image/*"
                    @file-uploaded="(file) => { headerImage = file; }"
                />
                <p class="mt-2 text-sm text-muted-foreground">
                    Recommended dimensions: 1920 × 360 pixels. JPG or PNG. This will be used as the page banner.
                </p>
            </div>
            <div class="mb-3">
